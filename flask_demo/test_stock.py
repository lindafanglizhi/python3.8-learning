...
def test_stock(size):
    url = 'https://xueqiu.com/service/v5/stock/screener/quote/list?type=sha&order_by=percent&order=desc&size='+str(size)+'&page=1'
    header = {
    ...
    result = res.json().get("data").get("list")[0]
    print(result)
